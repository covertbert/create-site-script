...
create_nginx_config() {
    CONFIG_STRING="server {
        ...
        ssl_certificate /home/webadmin/letsencrypt/config/live/$SITE_SLUG/fullchain.pem;
        ssl_certificate_key /home/webadmin/letsencrypt/config/live/$SITE_SLUG/privkey.pem;
